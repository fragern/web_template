        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group" clearfix>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="jenis_kelamin" value="jenis_kelamin" name="jenis_kelamin"  >
                      <label for="jenis_kelamin">
                          JENIS KELAMIN
                      </label>
                  </div>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="jenis_kelamin2" value="jenis_kelamin2" name="jenis_kelamin" >
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-1">
                      <a class="btn btn-success" id="foto_view" target="_blank"> <i class="fa fa-paperclip"></i> </a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-7">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="foto" multiple="" name="foto">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="input-group date" data-date-format="YYYY-MM-DD"  id="timepickertanggal_masuk" data-target-input="nearest">
                          <input type="text" id="tanggal_masuk" name="tanggal_masuk" class="form-control datetimepicker-input" data-target="#timepickertanggal_masuk"/>
                            <div class="input-group-append" data-target="#timepickertanggal_masuk" data-toggle="datetimepicker">
                              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                        </div>
                      </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="alamat" name="alamat" onchange="handleSelectChange_alamat(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <?php
                          foreach ($alamat as $value) {
                          echo "<option value='$value->alamat'>$value->alamat-$value->alamat</option>";
                          }
                        ?>
                      </select>
                    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_karyawan/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        nama: {
        required: "Please Input nama",
        minlength: 3
        },
        jenis_kelamin: {
        required: "Please Input jenis_kelamin",
        minlength: 3
        },
        foto: {
        required: "Please Input foto",
        minlength: 3
        },
        tanggal_masuk: {
        required: "Please Input tanggal_masuk",
        minlength: 3
        },
        alamat: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_karyawan/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                   ...
                   $('#nik').val(data.nik);
                    if(data.nama=='on'){
                        document.getElementById('nama').checked=true;
                    }else {
                          document.getElementById('nama').checked=false;
                    };
                    ...
                    document.getElementById('foto_label').innerHTML=data.foto;
                    var a = document.getElementById('foto_view');
                    if(!data.foto==''){
                      a.href = "<?php echo base_url('assets/upload/') ?>" + data.foto;
                    }else{
                      a.removeAttribute("href");
                    };
                    $('#tanggal_masuk').val(data.tanggal_masuk);
                    $('#alamat').select2().val(data.alamat).trigger('change');
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_karyawan/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_karyawan/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_karyawan/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_karyawan/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
