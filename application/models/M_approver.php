...
class M_approver extends CI_Model{
    ...
    public function Search_plan($search,$table)
    {
        ...
        $this->db->or_like('date_po',$search); 
    ...
    public function m_plandetails($kode_cip)
    {
            ...
            $this->db->select("kode_cip,kode_item_process,namaItemprocess,date_plan,date_actual,status,keterangan,active");
    ...
    function update_actual_cost_mrp(){
